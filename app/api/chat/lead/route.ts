...
<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#06030f;color:#e2d9f3;padding:32px;border-radius:16px;border:1px solid rgba(124,58,237,0.3);">
  ...
  <table style="width:100%;border-collapse:collapse;margin-bottom:20px;">
    <tr>
      ...
      <td style="padding:8px 0;color:#fff;font-weight:600;">${safeName || "Not provided"}</td>
    </tr>
    <tr>
      <td style="padding:8px 0;color:#9d8fd4;font-size:14px;">Email</td>
      <td style="padding:8px 0;"><a href="mailto:${safeEmail}" style="color:#a855f7;">${safeEmail || "Not provided"}</a></td>
    </tr>
    <tr>
  ...
  ${
    ...
    <pre style="color:#e2d9f3;font-size:12px;line-height:1.7;white-space:pre-wrap;margin:0;font-family:Arial,sans-serif;">${safeSummary}</pre>
  </div>`
      : ""
  }
  ${
    ...
    <a href="mailto:${safeEmail}" style="display:inline-block;padding:12px 28px;background:linear-gradient(135deg,#7c3aed,#a855f7);color:#fff;text-decoration:none;border-radius:50px;font-weight:700;font-size:14px;">Reply to ${safeName || "Lead"} →</a>
  </div>`
      : ""
  }
  <p style="text-align:center;color:#3d2f60;font-size:12px;margin:0;">PurpleSoftHub — purplesofthub.com</p>
</div>`,
        });
      } catch (emailError) {
