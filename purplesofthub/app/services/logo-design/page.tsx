...
export const metadata: Metadata = {
  ...
  description:
    "Professional logo design that captures your brand identity. Custom logo concepts, brand identity design, and high-quality delivery from ₦25,000.",
  keywords: ["logo design", "brand identity", "custom logo design", "logo design pricing", "professional branding"],
  alternates: { canonical: `${SITE_URL}/services/logo-design` },
  openGraph: {
    title: "Logo Design Services | PurpleSoftHub",
...
export default function LogoDesignPage() {
  ...
  const accent = "#8b5cf6";
  const description =
    "At PurpleSoftHub, we create professional, memorable logos that represent your brand identity and help your business stand out. Whether you are launching a new brand or refreshing an existing one, we deliver logo designs that leave a lasting impression.";
    ...
    <main style={{ background: "var(--bg-primary)", color: "var(--text-primary)", minHeight: "100vh", overflowX: "hidden" }}>
      ...
      <section style={{ padding: "40px 5% 80px", position: "relative", overflow: "hidden" }}>
        ...
        <div className="svc-hero-grid" style={{ maxWidth: 1100, margin: "0 auto", position: "relative", zIndex: 2, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }}>
          <div>
            <Reveal>
              <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "rgba(139,92,246,.12)", border: "1px solid rgba(168,85,247,.3)", borderRadius: 100, padding: "6px 16px", marginBottom: 20, fontSize: 12, fontWeight: 600, color: "var(--accent)", letterSpacing: 1 }}>
            ...
            <Reveal delay={0.1}>
              <h1 style={{ fontFamily: "Outfit", fontSize: "clamp(32px,4vw,56px)", fontWeight: 900, lineHeight: 1.1, color: "var(--text-primary)", letterSpacing: "-2px", marginBottom: 16 }}>
                <span className="grad-text">Design a Logo That Defines Your Brand</span>
              </h1>
            </Reveal>
            <Reveal delay={0.15}>
              <p style={{ fontFamily: "Outfit", fontSize: "clamp(17px,2vw,22px)", fontWeight: 600, color: "var(--text-secondary)", marginBottom: 20, lineHeight: 1.4 }}>
                Professional logo design that captures your brand identity
              </p>
            </Reveal>
            <Reveal delay={0.2}>
            ...
            <Reveal delay={0.25}>
              <div className="svc-hero-btns" style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
                <Link href="/services/logo-design/pricing">
          ...
          <Reveal delay={0.2}>
            <div className="glass-card animate-float svc-hero-card" style={{ padding: "48px 40px", textAlign: "center" }}>
              <div className="svc-hero-emoji" style={{ width: 88, height: 88, borderRadius: 24, background: `linear-gradient(135deg,${accent},#a855f7)`, margin: "0 auto 24px", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 44, boxShadow: `0 16px 48px ${accent}44` }}>
                {service.icon}
              </div>
              ...
              <div style={{ fontFamily: "Outfit", fontSize: 22, fontWeight: 900, color: "var(--text-primary)", marginBottom: 10 }}>
                <RegionalPrice amountNGN={25000} amountUSD={17} prefix="From " />
              </div>
              <div style={{ color: "var(--text-muted)", fontSize: 14, marginBottom: 28, lineHeight: 1.6 }}>
                Flexible logo design packages for startups, growing brands, and established businesses. All packages include professional delivery and high-quality design files.
              </div>
              <div style={{ display: "grid", gap: 10, marginBottom: 28, textAlign: "left" }}>
                {["Multiple design concepts", "Editable source files", "Fast turnaround", "Branding add-ons available"].map((item) => (
        ...
        <div className="svc-overview-grid" style={{ maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "start" }}>
          <Reveal>
            <div>
              ...
              <h2 style={{ fontFamily: "Outfit", fontSize: "clamp(26px,3vw,40px)", fontWeight: 900, color: "var(--text-primary)", letterSpacing: "-1.5px", lineHeight: 1.15, marginBottom: 20 }}>
                What&apos;s Included in Our <span className="grad-text">Logo Design</span> Service
              </h2>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                {[
                  ...
                  <span key={f} style={{ background: "rgba(124,58,237,.1)", border: "1px solid rgba(168,85,247,.25)", borderRadius: 100, padding: "5px 14px", fontSize: 12, color: "var(--accent)", fontWeight: 500 }}>
                    {f}
                  </span>
                ))}
              </div>
          ...
          <Reveal delay={0.15}>
            <div className="glass-card" style={{ padding: "36px 32px", position: "relative", overflow: "hidden" }}>
              <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 4, background: `linear-gradient(90deg,${accent},#a855f7)` }} />
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 28 }}>
                {["Multiple design concepts", "Editable source files", "Fast turnaround", "Branding add-ons available"].map((b) => (
          ...
          <Reveal>
            <div style={{ textAlign: "center", marginBottom: 56 }}>
              ...
              <h2 style={{ fontFamily: "Outfit", fontSize: "clamp(28px,3.5vw,46px)", fontWeight: 900, color: "var(--text-primary)", letterSpacing: "-1.5px" }}>
                Choose Your <span className="grad-text">Logo Plan</span>
              </h2>
            </div>
          </Reveal>
          <ServicePricingCards
        ...
        <Reveal>
          <div style={{ position: "relative", zIndex: 2, maxWidth: 660, margin: "0 auto" }}>
            ...
            <h2 style={{ fontFamily: "Outfit", fontSize: "clamp(30px,5vw,54px)", fontWeight: 900, color: "var(--text-primary)", letterSpacing: "-2px", lineHeight: 1.1, marginBottom: 20 }}>
              Ready to Build a Strong <span className="grad-text">Brand Identity</span>?
            </h2>
            <p style={{ color: "var(--text-muted)", fontSize: 17, marginBottom: 40, lineHeight: 1.7 }}>
              Explore the full pricing options to find the right logo design package for your business.
            </p>
