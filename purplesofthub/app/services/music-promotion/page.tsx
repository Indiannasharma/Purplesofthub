...
export const metadata: Metadata = {
  ...
  description: 'Organic music promotion to get your tracks heard. Real listeners, verified analytics, and platform-specific strategies.',
}
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: '1200px', margin: '0 auto', padding: 'clamp(40px, 6vw, 80px) 24px' }}>
          <div style={{ textAlign: 'center', marginBottom: 'clamp(48px, 6vw, 80px)' }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'rgba(124,58,237,0.1)', border: '1px solid rgba(124,58,237,0.25)', borderRadius: '100px', padding: '6px 18px', marginBottom: '24px' }}>
              ...
              <span style={{ fontSize: '12px', fontWeight: 700, color: '#7c3aed', letterSpacing: '0.08em', textTransform: 'uppercase' }}>Music Promotion</span>
            </div>
          ...
          <div style={{ marginBottom: '64px' }}>
            <h2 style={{ fontSize: 'clamp(24px, 3vw, 36px)', fontWeight: 900, color: 'var(--cyber-heading, #1a1a2e)', textAlign: 'center', margin: '0 0 8px' }}>Promotion Packages</h2>
            <p style={{ fontSize: '15px', color: 'var(--cyber-body, #4a3f6b)', textAlign: 'center', margin: '0 0 40px' }}>Platform-specific strategies tailored to your genre and target audience.</p>
          ...
          <div style={{ background: 'var(--cyber-card, rgba(255,255,255,0.7))', border: '1px solid var(--cyber-border, rgba(124,58,237,0.15))', borderRadius: '24px', padding: 'clamp(28px, 4vw, 48px)', backdropFilter: 'blur(10px)', marginBottom: '48px' }}>
            <h2 style={{ fontSize: 'clamp(22px, 3vw, 30px)', fontWeight: 900, color: 'var(--cyber-heading, #1a1a2e)', margin: '0 0 32px', textAlign: 'center' }}>Why Our Promotion?</h2>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: '24px' }}>
              {[
                { icon: '🎯', title: 'Real Organic Reach', desc: 'Genuine listeners and playlist placements, not bots.' },
                { icon: '📱', title: 'Platform Expertise', desc: 'We know what works on Spotify, TikTok, YouTube, and beyond.' },
                { icon: '✅', title: 'Proven Campaigns', desc: 'Thousands of artists promoted with measurable results.' },
                { icon: '📊', title: 'Analytics Tracking', desc: 'Daily dashboards showing plays, saves, and followers gained.' },
                { icon: '🤝', title: 'Influencer Network', desc: 'Access to content creators and playlist curators.' },
                { icon: '🎤', title: 'Artist-Focused', desc: 'Team of musicians who understand your needs.' },
              ].map(item => (
          ...
          <div style={{ background: 'linear-gradient(135deg, rgba(124,58,237,0.15), rgba(34,211,238,0.05))', border: '1px solid rgba(124,58,237,0.25)', borderRadius: '24px', padding: 'clamp(32px, 4vw, 48px)', textAlign: 'center' }}>
            <h2 style={{ fontSize: 'clamp(22px, 3vw, 32px)', fontWeight: 900, color: 'var(--cyber-heading, #1a1a2e)', margin: '0 0 12px' }}>Let's Promote Your Music</h2>
            <p style={{ fontSize: '15px', color: 'var(--cyber-body, #4a3f6b)', margin: '0 0 28px', lineHeight: 1.7 }}>Get your track in front of listeners. Organic, ethical, and results-driven.</p>
