...
export const metadata: Metadata = {
  title: "UI/UX Design Pricing | PurpleSoftHub",
  description:
    "Transparent UI/UX design pricing from N150,000. Compare Basic, Standard, Premium, and Enterprise plans.",
  keywords: ["ui ux pricing", "product design pricing", "dashboard design pricing", "PurpleSoftHub pricing"],
  alternates: { canonical: `${SITE_URL}/services/ui-ux-design/pricing` },
  openGraph: {
    title: "UI/UX Design Pricing | PurpleSoftHub",
    description: "Transparent UI/UX design pricing from N150,000",
    url: `${SITE_URL}/services/ui-ux-design/pricing`,
...
export default function UiUxDesignPricingPage() {
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          >
            ...
            >
              ...
              >
                Flexible UI/UX design plans for startups, businesses, and product teams that need
                clear user flows, polished interfaces, and developer-ready design delivery.
              </p>
            </div>
          </section>
