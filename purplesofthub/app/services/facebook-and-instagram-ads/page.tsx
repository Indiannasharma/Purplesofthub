...
import { getRelatedServices, getServiceBySlug } from "@/app/services/_data/services";
...
export const metadata: Metadata = {
  ...
  description:
    "Professional Facebook and Instagram ad management. We create targeted campaigns that drive real results. Plans from ₦42,000.",
  keywords: ["facebook ads", "instagram ads", "meta ads", "social media advertising", "facebook ads pricing"],
  alternates: { canonical: `${SITE_URL}/services/facebook-and-instagram-ads` },
  openGraph: {
    title: "Facebook & Instagram Ads Services | PurpleSoftHub",
    description: "Professional Facebook and Instagram Ads management from ₦42,000",
    url: `${SITE_URL}/services/facebook-and-instagram-ads`,
...
export default function FacebookAdsPage() {
  ...
  const jsonLd = {
    ...
    url: "https://purplesofthub.com/services/facebook-and-instagram-ads",
  };
      ...
      <section style={{ padding: "40px 5% 80px", position: "relative", overflow: "hidden" }}>
        <div
          style={{
            ...
            height: 800,
            borderRadius: "50%",
            background: `radial-gradient(circle,${service.color}22 0%,transparent 65%)`,
            top: "-20%",
            left: "-10%",
            pointerEvents: "none",
          }}
        ...
        <div
          ...
          style={{ maxWidth: 1100, margin: "0 auto", position: "relative", zIndex: 2, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }}
        >
          <div>
            <Reveal>
              <div
          ...
          <Reveal delay={0.2}>
            <div className="glass-card animate-float svc-hero-card" style={{ padding: "48px 40px", textAlign: "center" }}>
              <div
                className="svc-hero-emoji"
                style={{
                  width: 88,
                  height: 88,
                  borderRadius: 24,
                  background: `linear-gradient(135deg,${service.color},#a855f7)`,
                  margin: "0 auto 24px",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  fontSize: 44,
                  boxShadow: `0 16px 48px ${service.color}44`,
                }}
              >
                {service.icon}
              </div>
          ...
          <Reveal delay={0.15}>
            <div className="glass-card" style={{ padding: "36px 32px", position: "relative", overflow: "hidden" }}>
              ...
              <div style={{ fontFamily: "Outfit", fontSize: "clamp(26px,3vw,36px)", fontWeight: 900, background: "linear-gradient(135deg,#7c3aed,#a855f7)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", marginBottom: 6 }}>
                <RegionalPrice amountNGN={42000} amountUSD={30} prefix="From " />
              </div>
              ...
              <Link href="/services/facebook-and-instagram-ads/pricing">
            ...
            {service.features.map((f, i) => (
              <Reveal key={f} delay={i * 0.05}>
                <div className="glass-card" style={{ padding: "20px 24px", display: "flex", alignItems: "center", gap: 14 }}>
                  <div style={{ width: 32, height: 32, borderRadius: 8, background: "linear-gradient(135deg,#7c3aed,#a855f7)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 14, flexShrink: 0 }}>
                    ✓
                  </div>
          ...
          <Reveal delay={0.1}>
            <div style={{ display: "flex", flexWrap: "wrap", gap: 12, justifyContent: "center" }}>
              {service.technologies.map((t) => (
                <span key={t} className="glass-card" style={{ padding: "10px 20px", fontSize: 14, fontWeight: 600, color: "var(--accent)", borderRadius: 100 }}>
                  {t}
                </span>
              ))}
            </div>
                  ...
                  <Link href={`/services/${r.slug}`} style={{ textDecoration: "none" }}>
                    <div className="glass-card" style={{ padding: "28px 24px", cursor: "pointer" }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 12 }}>
                        <div style={{ width: 48, height: 48, borderRadius: 14, background: `linear-gradient(135deg,${r.color},#a855f7)`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 24, flexShrink: 0 }}>
                          {r.icon}
                        </div>
