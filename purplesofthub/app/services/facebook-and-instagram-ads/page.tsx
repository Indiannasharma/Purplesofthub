...
export const metadata: Metadata = {
  ...
  description: "Professional Facebook and Instagram ad management. We create targeted campaigns that drive real results. Plans from â‚¦42,000.",
  ...
  openGraph: {
    title: "Facebook & Instagram Ads Services | PurpleSoftHub",
    description: "Professional Facebook and Instagram Ads management from â‚¦42,000",
...
export default function FacebookAdsPage() {
  ...
  return (
    <main style={{ background: "var(--bg-primary)", color: "var(--text-primary)", minHeight: "100vh", overflowX: "hidden" }}>
      ...
      <div className="svc-breadcrumb" style={{ padding: "100px 5% 0" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 13, color: "var(--text-muted)", flexWrap: "wrap" }}>
            ...
            <span style={{ color: "rgba(168,85,247,.4)" }}>â€º</span>
          ...
          <div>
            ...
            <Reveal delay={0.25}>
              <div className="svc-hero-btns" style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
                ...
                <Link href="/contact">
                  <button className="btn-outline" style={{ padding: "14px 30px", fontSize: 15 }}>Book a Free Call â†’</button>
                </Link>
              </div>
            </Reveal>
          </div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 28 }}>
                {["Flex Weekly plans available", "Flexible payment options", "Ad spend paid directly to Meta"].map((b) => (
                  <div key={b} style={{ display: "flex", alignItems: "flex-start", gap: 10 }}>
                    <span style={{ color: "#a855f7", fontSize: 14, flexShrink: 0, marginTop: 1 }}>âœ“</span>
            ...
            {service.features.map((f, i) => (
              <Reveal key={f} delay={i * 0.05}>
                <div className="glass-card" style={{ padding: "20px 24px", display: "flex", alignItems: "center", gap: 14 }}>
                  <div style={{ width: 32, height: 32, borderRadius: 8, background: "linear-gradient(135deg,#7c3aed,#a855f7)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 14, flexShrink: 0 }}>âœ“</div>
      ...
      {/* â”€â”€ PRICING PREVIEW (Facebook Ads Specific) â”€â”€ */}
      <FacebookAdsPricing />

      {/* â”€â”€ FAQs (ACCORDION) â”€â”€ */}
      <section style={{ padding: "90px 5%", background: "rgba(124,58,237,.04)", borderTop: "1px solid rgba(124,58,237,.12)", borderBottom: "1px solid rgba(124,58,237,.12)" }}>
                ...
                <Reveal key={r.slug} delay={i * 0.08}>
                  <Link href={`/services/${r.slug}`} style={{ textDecoration: "none" }}>
                    <div className="glass-card" style={{ padding: "28px 24px", cursor: "pointer" }}>
                      ...
                      <span style={{ color: "var(--accent)", fontSize: 13, fontWeight: 600 }}>Learn more â†’</span>
                    </div>
                  </Link>
                </Reveal>
              ))}
        ...
        <Reveal>
          <div style={{ position: "relative", zIndex: 2, maxWidth: 660, margin: "0 auto" }}>
            ...
            <div className="svc-cta-btns" style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" }}>
              ...
              <Link href="/services">
                <button className="btn-outline" style={{ padding: "16px 38px", fontSize: 16 }}>All Services â†’</button>
              </Link>
            </div>
          </div>
        </Reveal>
