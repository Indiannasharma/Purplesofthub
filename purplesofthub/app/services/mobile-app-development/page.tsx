...
export const metadata: Metadata = {
  ...
  description:
    "Modern mobile app development for startups, businesses, and digital products. Build Android and iOS apps from MVP to full-scale launch from ₦750,000.",
  keywords: ["mobile app development", "react native development", "flutter development", "android app", "ios app"],
  alternates: { canonical: `${SITE_URL}/services/mobile-app-development` },
  openGraph: {
    title: "Mobile App Development | PurpleSoftHub",
    description: "Modern mobile app development from ₦750,000",
...
const mobileFaqs = [
  {
    ...
    a: "Yes. We build Android and iOS apps using modern cross-platform technologies like React Native and Flutter.",
  },
  {
    q: "Can you build an MVP first?",
    a: "Yes. We can help you start with an MVP so you can test your idea, get feedback, and scale gradually.",
  },
  {
    q: "Do you handle app deployment?",
    a: "Yes. We provide guidance and support for preparing your app for Play Store and App Store deployment.",
  },
];

const mobileRelatedServices = [
  {
    title: "Web Development",
    description: "Build a fast website or dashboard for your mobile app.",
  ...
  {
    title: "UI/UX Design",
    description: "Design user-friendly interfaces for your app idea.",
  ...
  },
  {
    ...
    description: "Build scalable software platforms and subscription products.",
...
export default function MobileAppDevelopmentPage() {
  ...
  const accent = "#7c3aed";
  const description =
    "At PurpleSoftHub, we design and develop modern mobile applications that help businesses, startups, and creators deliver seamless digital experiences. From MVPs to full-scale apps, we build fast, scalable, and user-friendly mobile solutions.";
          ...
          <div>
            ...
            <Reveal delay={0.1}>
              <h1 style={{ fontFamily: "Outfit", fontSize: "clamp(32px,4vw,56px)", fontWeight: 900, lineHeight: 1.1, color: "var(--text-primary)", letterSpacing: "-2px", marginBottom: 16 }}>
                <span className="grad-text">Build Powerful Mobile Apps for Android and iOS</span>
              </h1>
            </Reveal>
            <Reveal delay={0.15}>
              <p style={{ fontFamily: "Outfit", fontSize: "clamp(17px,2vw,22px)", fontWeight: 600, color: "var(--text-secondary)", marginBottom: 20, lineHeight: 1.4 }}>
                Mobile app experiences built for growth, usability, and long-term scale
              </p>
            </Reveal>
            <Reveal delay={0.2}>
            ...
            <Reveal delay={0.25}>
              <div className="svc-hero-btns" style={{ display: "flex", gap: 14, flexWrap: "wrap" }}>
                <Link href="/services/mobile-app-development/pricing">
          ...
          <Reveal delay={0.2}>
            <div className="glass-card animate-float svc-hero-card" style={{ padding: "48px 40px", textAlign: "center" }}>
              ...
              <div style={{ fontFamily: "Outfit", fontSize: 22, fontWeight: 900, color: "var(--text-primary)", marginBottom: 10 }}>
                <RegionalPrice amountNGN={750000} amountUSD={500} prefix="From " />
              </div>
              <div style={{ color: "var(--text-muted)", fontSize: 14, marginBottom: 28, lineHeight: 1.6 }}>
                Flexible mobile app development packages for startups, businesses, and digital platforms. Choose a plan based on your app features, timeline, and growth needs.
              </div>
              <div style={{ display: "grid", gap: 10, marginBottom: 28, textAlign: "left" }}>
                {["Android & iOS support", "Clean UI/UX design", "Backend/API integration", "Scalable app architecture"].map((item) => (
          ...
          <Reveal>
            <div>
              ...
              <h2 style={{ fontFamily: "Outfit", fontSize: "clamp(26px,3vw,40px)", fontWeight: 900, color: "var(--text-primary)", letterSpacing: "-1.5px", lineHeight: 1.15, marginBottom: 20 }}>
                What&apos;s Included in Our <span className="grad-text">Mobile App Development</span> Service
              </h2>
      ...
      <section id="pricing" style={{ padding: "90px 5%" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div style={{ textAlign: "center" }}>
            <Link
              href="/services/mobile-app-development/pricing"
              style={{
                display: "inline-flex",
                alignItems: "center",
                gap: "10px",
      ...
      <section style={{ padding: "80px 5%" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(280px,1fr))", gap: 20 }}>
            {mobileRelatedServices.map((item, i) => (
        ...
        <Reveal>
          <div style={{ position: "relative", zIndex: 2, maxWidth: 660, margin: "0 auto" }}>
            ...
            <h2 style={{ fontFamily: "Outfit", fontSize: "clamp(30px,5vw,54px)", fontWeight: 900, color: "var(--text-primary)", letterSpacing: "-2px", lineHeight: 1.1, marginBottom: 20 }}>
              Ready to Launch a Stronger <span className="grad-text">Mobile Product</span>?
            </h2>
            <p style={{ color: "var(--text-muted)", fontSize: 17, marginBottom: 40, lineHeight: 1.7 }}>
              Explore the full pricing options and choose the development plan that matches your product roadmap.
            </p>
