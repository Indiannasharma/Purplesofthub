...
export const metadata: Metadata = {
  title: "Mobile App Development Pricing | PurpleSoftHub",
  description:
    "Transparent mobile app development pricing from ₦750,000. Compare Starter, Growth, Pro, and Enterprise plans.",
  keywords: ["mobile app pricing", "app development plans", "react native pricing", "flutter pricing"],
  alternates: { canonical: `${SITE_URL}/services/mobile-app-development/pricing` },
  openGraph: {
    title: "Mobile App Development Pricing | PurpleSoftHub",
    description: "Transparent mobile app development pricing from ₦750,000",
    url: `${SITE_URL}/services/mobile-app-development/pricing`,
    siteName: "PurpleSoftHub",
    type: "website",
  },
  twitter: {
    card: "summary_large_image",
    title: "Mobile App Development Pricing",
    description: "Transparent mobile app development pricing from ₦750,000",
  },
};

export default function MobileAppDevelopmentPricingPage() {
          ...
          <section style={{
            ...
            <div style={{
              ...
              <p style={{
                ...
                Flexible mobile app development plans for startups, businesses, and scalable digital products across Android and iOS.
              </p>
            </div>
          </section>
