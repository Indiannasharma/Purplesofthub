...
export const metadata: Metadata = {
  title: "Web Development & Design Services | PurpleSoftHub",
  description: "Custom website development, SaaS platforms, and web applications. From ₦450,000 - all plans include mobile responsive design, SEO setup, and SSL.",
  keywords: ["web development", "website design", "SaaS development", "responsive design", "web development pricing"],
  alternates: { canonical: `${SITE_URL}/services/web-development` },
  openGraph: {
    title: "Web Development & Design Services | PurpleSoftHub",
    description: "Custom website development from ₦450,000",
...
export default function WebDevelopmentPage() {
  ...
  const jsonLd = {
    ...
    url: `https://purplesofthub.com/services/web-development`,
  };
          ...
          <Reveal delay={0.15}>
            <div className="glass-card" style={{ padding: "36px 32px", position: "relative", overflow: "hidden" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 28 }}>
                {["Starter to Diamond plans available", "Flexible payment options", "Custom quotes available"].map((b) => (
              ...
              <Link href="/services/web-development/pricing">
