...
const SERVICE_PLANS: Record<string, Plan[]> = {
  'meta-ads': [
    ...
    },
    {
      name: 'Starter',
      price: 150000,
      deliveryTime: 'Per Month',
      features: ['2 ad campaigns', 'Basic targeting', 'Weekly reports', 'Email support', 'Budget optimization'],
    },
    {
      name: 'Growth',
      price: 250000,
      deliveryTime: 'Per Month',
      features: ['5 ad campaigns', 'Advanced targeting', 'Daily optimization', 'Priority support', 'A/B testing', 'Lookalike audiences'],
      popular: true,
    },
    {
      name: 'Scale',
      price: 400000,
      deliveryTime: 'Per Month',
      features: ['Unlimited campaigns', 'Advanced lookalikes', 'Conversion tracking', '24/7 support', 'Custom creatives', 'Multi-adset optimization'],
    },
    {
      name: 'Enterprise',
      price: 600000,
      deliveryTime: 'Per Month',
      features: ['Full service management', 'Dedicated account manager', 'Custom reporting', 'Multi-platform integration', 'Strategy calls', 'Custom audiences'],
    },
  ],
  'web-dev': [
    {
