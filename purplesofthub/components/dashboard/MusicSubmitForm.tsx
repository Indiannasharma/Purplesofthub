...
export default function MusicSubmitForm({
  ...
  const formContent = (
    <div className="fixed inset-0 z-[10000] flex items-stretch justify-center overflow-hidden bg-slate-950/80 p-0 backdrop-blur-md sm:p-5 lg:items-center">
      <div className="relative flex h-dvh max-h-dvh w-full max-w-full flex-col overflow-hidden border-0 border-white/10 bg-slate-50 shadow-2xl shadow-brand-950/40 dark:bg-[#070b16] sm:h-auto sm:max-h-[91dvh] sm:max-w-5xl sm:rounded-2xl sm:border">
        <div className="relative border-b border-white/10 bg-slate-950 px-4 py-4 text-white sm:px-6">
        ...
        <form onSubmit={handleSubmit} className="relative flex min-h-0 flex-1 flex-col">
          <div className="min-h-0 flex-1 overflow-y-auto px-3 py-4 sm:px-5 sm:py-5">
            <div className="mx-auto max-w-4xl">
              <div className="mb-4 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm shadow-slate-950/5 dark:border-white/10 dark:bg-white/[0.045] dark:shadow-none">
              ...
              <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm shadow-slate-950/5 dark:border-white/10 dark:bg-white/[0.045] dark:shadow-none">
                        ...
                        {commonPlatforms.map(platform => {
                          ...
                          return (
                            <button
                              ...
                              disabled={loading}
                              className={`group flex min-h-11 items-center justify-between gap-2 rounded-lg border px-3 py-2 text-left text-xs font-extrabold transition focus:outline-none focus:ring-4 focus:ring-brand-500/10 disabled:cursor-not-allowed disabled:opacity-60 ${
                                selected
          ...
          <div className="shrink-0 border-t border-slate-200 bg-white/95 p-3 backdrop-blur dark:border-white/10 dark:bg-[#080d1a]/95 sm:px-5 sm:py-3">
            <div className="mx-auto flex max-w-4xl flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex gap-3 sm:shrink-0">
                <button
                  ...
                  onClick={onClose}
                  disabled={loading}
                  className="h-11 flex-1 rounded-lg border border-slate-200 px-5 text-sm font-extrabold text-slate-700 transition hover:bg-slate-50 disabled:opacity-50 dark:border-white/10 dark:text-white dark:hover:bg-white/10 sm:flex-none"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  disabled={loading}
                  className="h-11 flex-1 rounded-lg bg-gradient-to-r from-brand-600 via-brand-500 to-fuchsia-500 px-6 text-sm font-extrabold text-white shadow-lg shadow-brand-500/30 transition hover:scale-[1.01] disabled:cursor-not-allowed disabled:opacity-60 sm:flex-none"
                >
